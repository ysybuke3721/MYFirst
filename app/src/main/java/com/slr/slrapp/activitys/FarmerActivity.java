...
public class FarmerActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        farmer_img_location = (ImageView) findViewById(R.id.farmer_img_location);
        farmer_img_right = (ImageView) findViewById(R.id.farmer_img_right);
        rl_title_farmerpage = (RelativeLayout) findViewById(R.id.rl_title_farmerpage);
        select_tv_1 = (TextView) findViewById(R.id.select_tv_1);
        rl_all_kinds = (RelativeLayout) findViewById(R.id.rl_all_kinds);
        select_tv_2 = (TextView) findViewById(R.id.select_tv_2);
        rl_smart_sort = (RelativeLayout) findViewById(R.id.rl_smart_sort);
        select_tv_3 = (TextView) findViewById(R.id.select_tv_3);
        rl_filter = (RelativeLayout) findViewById(R.id.rl_filter);
        farmer_goods_lv = (PullableListView) findViewById(R.id.farmer_goods_lv);

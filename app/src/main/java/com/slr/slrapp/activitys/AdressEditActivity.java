...
public class AdressEditActivity extends BaseActivity{
    ...
    private MyAdressBean.ListBean listBean;
    ...
    private ArrayList<ArrayList<ArrayList<String>>> options3Items = new ArrayList<ArrayList<ArrayList<String>>>();// 用户id
    ...
    public void initData() {
        ...
        listBean = (MyAdressBean.ListBean) intent.getExtras().getSerializable("editAdress");
        adress_add_name.setText(listBean.getReceiptName());
        adress_add_area.setText(listBean.getReceiptAddress().substring(0, listBean.getReceiptAddress().indexOf(",")));
        adress_add_detail.setText(listBean.getReceiptAddress().substring(listBean.getReceiptAddress().indexOf(",")+1));
        adress_add_phone.setText(listBean.getReceiptTel());
        if (listBean.getIfAddress().equals("1")) {
            adress_add_default_select.setChecked(true);
        }
        loadCityPicker();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.title_right:
                String url = ApiUtils.AddressUpdate();
                save(url);
                break;

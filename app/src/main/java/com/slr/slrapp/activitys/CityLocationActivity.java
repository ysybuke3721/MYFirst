...
import com.slr.slrapp.beans.City;
import com.slr.slrapp.helper.DBHelper;
import com.slr.slrapp.helper.DatabaseHelper;
import com.slr.slrapp.utils.ContentValues;
import com.slr.slrapp.utils.PingYinUtil;
import com.slr.slrapp.utils.ThreadUtils;
import com.slr.slrapp.utils.ToastUtil;
import com.slr.slrapp.widget.MyLetterListView;
...
public class CityLocationActivity extends Activity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    ...
                    getLocatedCityName(allCity_lists.get(position).getName());
                }
            }
        });
        locateProcess = 1;
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                //将点击的城市结果传递给首页
                getLocatedCityName(city_result.get(position).getName());
...
//            Log.i("BaiduLocationApiDem", sb.toString());
            ...
            adapter.notifyDataSetChanged();
//
//           double a= bdLocation.getLatitude();  //维度
//            double b=bdLocation.getLongitude();  //经度
//
//            ToastUtil.showTextToast("经度"+b+"维度"+a);
            ...
            if (viewType == 0) { // 定位
                ...
                city.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (locateProcess == 2) {
                            //TODO
                            //  ToastUtil.showTextToast(UiUtils.getContext(),city.getText().toString());

                            //定位结果传递给首页
                            getLocatedCityName(city.getText().toString());
                ...
                rencentCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        //TODO　　
                        //    ToastUtil.showTextToast(UiUtils.getContext(),city_history.get(position));
                        getLocatedCityName(city_history.get(position));
                    }
                });
...
//                                Toast.LENGTH_SHORT).show();
                        ...
                        getLocatedCityName(city_hot.get(position).getName());
    ...
    //将定位到的城市名数据传递给首页
    public void getLocatedCityName(String name) {
        if ("郑州".equals(name) || "郑州市".equals(name)) {

        } else {
            ToastUtil.showTextToast("暂不支持该城市");
            return;
        }
        Intent intent = new Intent();
        intent.putExtra(ContentValues.LOCATED_CITY_NAME, name);
        CityLocationActivity.this.setResult(RESULT_CODE, intent);


        //隐藏输入法

        ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(CityLocationActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);

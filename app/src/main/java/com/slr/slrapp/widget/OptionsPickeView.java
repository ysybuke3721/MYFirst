 ...
 */
public class OptionsPickeView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public OptionsPickeView(Context context) {
        super(context);
    ...
    public void onClick(View v)
    {
        ...
        else
        {
            if(optionsSelectListener!=null)
            {
                ...
                System.out.println("地址选择："+optionsCurrentItems[0]+"///"+optionsCurrentItems[1]+"////"+optionsCurrentItems[2]);
                if (optionsCurrentItems[0]==15&&optionsCurrentItems[1]==0){
                    optionsSelectListener.onOptionsSelect(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2]);
                    dismiss();
                    return;
                }else {
                    ToastUtil.showTextToast("目前只有河南郑州开通服务，请选择该地区！");
                }
            }
        }
    }
